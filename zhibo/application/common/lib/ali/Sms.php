...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIaH6JmQgcmhlm"; // AccessKeyId

        $accessKeySecret = "mtzzBHHFTBmv2uKRYb4mG3xxF4cgiz"; // AccessKeySecret
    ...
    public static function sendSms($phone,$code) {
        ...
        $request->setSignName("php个人开发");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_147439556");
